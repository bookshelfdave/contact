...
public interface ContactListener extends ParseTreeListener {
    ...
    void enterMapRedPhaseTypeLink(ContactParser.MapRedPhaseTypeLinkContext ctx);

    void exitMapRedPhaseTypeLink(ContactParser.MapRedPhaseTypeLinkContext ctx);
    ...
    void enterMapRedLangErlang(ContactParser.MapRedLangErlangContext ctx);

    void exitMapRedLangErlang(ContactParser.MapRedLangErlangContext ctx);

    void enterOptionslist(ContactParser.OptionslistContext ctx);

    void exitOptionslist(ContactParser.OptionslistContext ctx);

    void enterMapred_keyfilter_args(ContactParser.Mapred_keyfilter_argsContext ctx);

    void exitMapred_keyfilter_args(ContactParser.Mapred_keyfilter_argsContext ctx);
    ...
    void enterMapRedLangJavascript(ContactParser.MapRedLangJavascriptContext ctx);

    void exitMapRedLangJavascript(ContactParser.MapRedLangJavascriptContext ctx);

    void enterMapred_input_join(ContactParser.Mapred_input_joinContext ctx);

    void exitMapred_input_join(ContactParser.Mapred_input_joinContext ctx);
    ...
    void enterMapred_bucket(ContactParser.Mapred_bucketContext ctx);

    void exitMapred_bucket(ContactParser.Mapred_bucketContext ctx);
    ...
    void enterMapred_keyfilter(ContactParser.Mapred_keyfilterContext ctx);

    void exitMapred_keyfilter(ContactParser.Mapred_keyfilterContext ctx);
    ...
    void enterMapred_keyfilters(ContactParser.Mapred_keyfiltersContext ctx);

    void exitMapred_keyfilters(ContactParser.Mapred_keyfiltersContext ctx);
    ...
    void enterMapred_keyfilter_arg(ContactParser.Mapred_keyfilter_argContext ctx);

    void exitMapred_keyfilter_arg(ContactParser.Mapred_keyfilter_argContext ctx);

    void enterMapred_inputs(ContactParser.Mapred_inputsContext ctx);

    void exitMapred_inputs(ContactParser.Mapred_inputsContext ctx);

    void enterMapRedPhaseTypeMap(ContactParser.MapRedPhaseTypeMapContext ctx);

    void exitMapRedPhaseTypeMap(ContactParser.MapRedPhaseTypeMapContext ctx);
    ...
    void enterMapred_phase(ContactParser.Mapred_phaseContext ctx);

    void exitMapred_phase(ContactParser.Mapred_phaseContext ctx);
    ...
    void enterMapred(ContactParser.MapredContext ctx);

    void exitMapred(ContactParser.MapredContext ctx);

    void enterMapRedPhaseTypeReduce(ContactParser.MapRedPhaseTypeReduceContext ctx);

    void exitMapRedPhaseTypeReduce(ContactParser.MapRedPhaseTypeReduceContext ctx);

    void enterPairIntValue(ContactParser.PairIntValueContext ctx);

    void exitPairIntValue(ContactParser.PairIntValueContext ctx);

    void enterMapred_phase_keep(ContactParser.Mapred_phase_keepContext ctx);

    void exitMapred_phase_keep(ContactParser.Mapred_phase_keepContext ctx);
