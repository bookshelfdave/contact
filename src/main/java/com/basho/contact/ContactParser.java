...
public class ContactParser extends Parser {
    ...
    public static class ProgContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(ContactParser.EOF, 0);
        }
    ...
    public static class StatContext extends ParserRuleContext {
        ...
        public TerminalNode SEMI() {
            return getToken(ContactParser.SEMI, 0);
        }
    ...
    public static class AssignmentContext extends ParserRuleContext {
        ...
        public TerminalNode EQUALS() {
            return getToken(ContactParser.EQUALS, 0);
        }

        public TerminalNode ID() {
            return getToken(ContactParser.ID, 0);
        }

        public TerminalNode LET() {
            return getToken(ContactParser.LET, 0);
        }
    ...
    public static class UsingContext extends ParserRuleContext {
        ...
        public TerminalNode BUCKET() {
            return getToken(ContactParser.BUCKET, 0);
        }

        public TerminalNode USING() {
            return getToken(ContactParser.USING, 0);
        }

        public TerminalNode STRING() {
            return getToken(ContactParser.STRING, 0);
        }
    ...
    public final UsingContext using() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(BUCKET);
                setState(113);
                ((UsingContext) _localctx).bucket = match(STRING);
                setState(114);
                op_with_options();
            }
        } catch (RecognitionException re) {
    ...
    public static class WithContext extends ParserRuleContext {
        public TerminalNode AND() {
            return getToken(ContactParser.AND, 0);
        }

        public TerminalNode WITH() {
            return getToken(ContactParser.WITH, 0);
        }
    ...
    public static class OptionsContext extends ParserRuleContext {
        ...
        public TerminalNode OPTIONS() {
            return getToken(ContactParser.OPTIONS, 0);
        }
    ...
    public static class ListbucketsContext extends ParserRuleContext {
        public TerminalNode LIST() {
            return getToken(ContactParser.LIST, 0);
        }

        public TerminalNode BUCKETS() {
            return getToken(ContactParser.BUCKETS, 0);
        }
    ...
    public static class ListkeysContext extends ParserRuleContext {
        public TerminalNode KEYS() {
            return getToken(ContactParser.KEYS, 0);
        }
    ...
    public static class OptionslistContext extends ParserRuleContext {
        ...
        public List<TerminalNode> COMMA() {
            return getTokens(ContactParser.COMMA);
        }
    ...
    public final OptionslistContext optionslist() throws RecognitionException {
        ...
        try {
            ...
            {
                setState(141);
                ((OptionslistContext) _localctx).pair = pair();
    ...
    public static class FetchContext extends ParserRuleContext {
        ...
        public TerminalNode FETCH() {
            return getToken(ContactParser.FETCH, 0);
        }
    ...
    public final FetchContext fetch() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(FETCH);
                setState(150);
                ((FetchContext) _localctx).key = match(STRING);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class StoreContext extends ParserRuleContext {
        ...
        public TerminalNode STORE() {
            return getToken(ContactParser.STORE, 0);
        }
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                switch (_input.LA(1)) {
                    case STRING: {
                        setState(153);
                        ((StoreContext) _localctx).key = match(STRING);
                    }
                    break;
                    case ID: {
                        setState(154);
                        ((StoreContext) _localctx).existing_obj = match(ID);
                    }
                    break;
                    default:
                        throw new NoViableAltException(this);
    ...
    public static class ShowContext extends ParserRuleContext {
        ...
        public TerminalNode DETAIL() {
            return getToken(ContactParser.DETAIL, 0);
        }
        ...
        public TerminalNode SHOW() {
            return getToken(ContactParser.SHOW, 0);
        }
    ...
    public static class Store_indexesContext extends ParserRuleContext {
        public List<TerminalNode> INDEX() {
            return getTokens(ContactParser.INDEX);
        }
    ...
    public static class Content_stringContext extends ParserRuleContext {
        public TerminalNode JSON() {
            return getToken(ContactParser.JSON, 0);
        }

        public TerminalNode TEXT() {
            return getToken(ContactParser.TEXT, 0);
        }

        public TerminalNode XML() {
            return getToken(ContactParser.XML, 0);
        }

        public TerminalNode DATA_CONTENT() {
            return getToken(ContactParser.DATA_CONTENT, 0);
        }
    ...
    public static class DeleteContext extends ParserRuleContext {
        ...
        public TerminalNode DELETE() {
            return getToken(ContactParser.DELETE, 0);
        }
    ...
    public final DeleteContext delete() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(DELETE);
                setState(183);
                ((DeleteContext) _localctx).key = match(STRING);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class Query2iContext extends ParserRuleContext {
        ...
        public TerminalNode INDEX() {
            return getToken(ContactParser.INDEX, 0);
        }
        ...
        public TerminalNode VALUE() {
            return getToken(ContactParser.VALUE, 0);
        }

        public TerminalNode TO() {
            return getToken(ContactParser.TO, 0);
        }

        public TerminalNode FROM() {
            return getToken(ContactParser.FROM, 0);
        }

        public TerminalNode QUERY2I() {
            return getToken(ContactParser.QUERY2I, 0);
        }

        public List<TerminalNode> STRING() {
            return getTokens(ContactParser.STRING);
        }
    ...
    public final Query2iContext query2i() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(INDEX);
                setState(188);
                ((Query2iContext) _localctx).index = match(STRING);
                setState(197);
                switch (_input.LA(1)) {
                    case WITH:
                    case AND: {
                        ...
                        match(VALUE);
                        setState(191);
                        ((Query2iContext) _localctx).exact = match(STRING);
                    }
                    break;
                    case FROM: {
                        setState(193);
                        match(FROM);
                        setState(194);
                        ((Query2iContext) _localctx).vmin = match(STRING);
                        setState(195);
                        match(TO);
                        setState(196);
                        ((Query2iContext) _localctx).vmax = match(STRING);
                    }
                    break;
                    default:
                        throw new NoViableAltException(this);
    ...
    public static class MapredContext extends ParserRuleContext {
        ...
        public TerminalNode MAPRED() {
            return getToken(ContactParser.MAPRED, 0);
        }
    ...
    public final Mapred_bucketContext mapred_bucket() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(BUCKET);
                setState(211);
                ((Mapred_bucketContext) _localctx).name = match(STRING);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class Mapred_phaseContext extends ParserRuleContext {
        ...
        public TerminalNode FILTERS() {
            return getToken(ContactParser.FILTERS, 0);
        }

        public TerminalNode PHASE() {
            return getToken(ContactParser.PHASE, 0);
        }
    ...
    public static class MapRedPhaseTypeLinkContext extends Mapred_phase_typeContext {
        public TerminalNode LINK() {
            return getToken(ContactParser.LINK, 0);
        }

        public MapRedPhaseTypeLinkContext(Mapred_phase_typeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class MapRedPhaseTypeReduceContext extends Mapred_phase_typeContext {
        public TerminalNode REDUCE() {
            return getToken(ContactParser.REDUCE, 0);
        }

        public MapRedPhaseTypeReduceContext(Mapred_phase_typeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class MapRedPhaseTypeMapContext extends Mapred_phase_typeContext {
        public TerminalNode MAP() {
            return getToken(ContactParser.MAP, 0);
        }

        public MapRedPhaseTypeMapContext(Mapred_phase_typeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Mapred_phase_keepContext extends ParserRuleContext {
        public TerminalNode KEEP() {
            return getToken(ContactParser.KEEP, 0);
        }
    ...
    public static class Mapred_inputsContext extends ParserRuleContext {
        ...
        public TerminalNode INPUTS() {
            return getToken(ContactParser.INPUTS, 0);
        }
    ...
    public final Mapred_inputsContext mapred_inputs() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(INPUTS);
                setState(237);
                ((Mapred_inputsContext) _localctx).pair = pair();
    ...
    public static class Mapred_input_joinContext extends ParserRuleContext {
        public TerminalNode NOT() {
            return getToken(ContactParser.NOT, 0);
        }
        ...
        public TerminalNode OR() {
            return getToken(ContactParser.OR, 0);
        }
    ...
    public static class MapRedLangErlangContext extends Mapred_langContext {
        public TerminalNode ERLANG() {
            return getToken(ContactParser.ERLANG, 0);
        }

        public MapRedLangErlangContext(Mapred_langContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class MapRedLangJavascriptContext extends Mapred_langContext {
        public TerminalNode JAVASCRIPT() {
            return getToken(ContactParser.JAVASCRIPT, 0);
        }

        public MapRedLangJavascriptContext(Mapred_langContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Mapred_keyfilterContext extends ParserRuleContext {
        public TerminalNode RPAREN() {
            return getToken(ContactParser.RPAREN, 0);
        }
        ...
        public TerminalNode LPAREN() {
            return getToken(ContactParser.LPAREN, 0);
        }
    ...
    public static class Mapred_keyfilter_argsContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_mapred_keyfilter_args;
        }
    ...
    public static class Mapred_keyfilter_argContext extends ParserRuleContext {
        public TerminalNode INT() {
            return getToken(ContactParser.INT, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_mapred_keyfilter_arg;
        }
    ...
    public static class UseContext extends ParserRuleContext {
        ...
        public TerminalNode USE() {
            return getToken(ContactParser.USE, 0);
        }

        public TerminalNode CONN() {
            return getToken(ContactParser.CONN, 0);
        }
                    ...
                    case BUCKET: {
                        {
                            ...
                            match(BUCKET);
                            setState(289);
                            ((UseContext) _localctx).name = match(STRING);
                        }
                    }
                    break;
                    case CONN: {
                        {
                            ...
                            match(CONN);
                            setState(291);
                            ((UseContext) _localctx).var = match(ID);
                        }
                    }
                    break;
                    default:
    ...
    public static class ConnectContext extends ParserRuleContext {
        ...
        public List<TerminalNode> INT() {
            return getTokens(ContactParser.INT);
        }

        public TerminalNode HTTP() {
            return getToken(ContactParser.HTTP, 0);
        }

        public TerminalNode CONNECT() {
            return getToken(ContactParser.CONNECT, 0);
        }
        ...
        public TerminalNode PB() {
            return getToken(ContactParser.PB, 0);
        }

        public TerminalNode DEFAULT() {
            return getToken(ContactParser.DEFAULT, 0);
        }
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                switch (_input.LA(1)) {
                    ...
                    case STRING: {
                        setState(296);
                        ((ConnectContext) _localctx).host = match(STRING);
                        setState(297);
                        match(PB);
                        setState(298);
                        ((ConnectContext) _localctx).pbport = match(INT);
                        setState(301);
                        _la = _input.LA(1);
                        if (_la == HTTP) {
                            {
                                ...
                                match(HTTP);
                                setState(300);
                                ((ConnectContext) _localctx).httpport = match(INT);
                            }
                        }
    ...
    public static class SetContext extends ParserRuleContext {
        public TerminalNode SET() {
            return getToken(ContactParser.SET, 0);
        }
    ...
    public static class Set_actionContext extends ParserRuleContext {
        ...
        public TerminalNode ACTION() {
            return getToken(ContactParser.ACTION, 0);
        }
    ...
    public final Set_actionContext set_action() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(ACTION);
                setState(309);
                ((Set_actionContext) _localctx).actionname = match(ID);
                setState(310);
                match(WITH);
                setState(311);
                code_string();
    ...
    public static class GetContext extends ParserRuleContext {
        ...
        public TerminalNode GET() {
            return getToken(ContactParser.GET, 0);
        }
    ...
    public final Get_actionContext get_action() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(ACTION);
                setState(319);
                ((Get_actionContext) _localctx).actionname = match(ID);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class Get_bucketpropsContext extends ParserRuleContext {
        ...
        public TerminalNode PROPERTIES() {
            return getToken(ContactParser.PROPERTIES, 0);
        }
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                switch (_input.LA(1)) {
                    case STRING: {
                        setState(324);
                        ((PairContext) _localctx).name = match(STRING);
                    }
                    break;
                    case ID: {
                        setState(325);
    ...
    public static class PairStringValueContext extends PairValueContext {
        ...
        public PairStringValueContext(PairValueContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class PairIntValueContext extends PairValueContext {
        ...
        public PairIntValueContext(PairValueContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class PairBoolValueContext extends PairValueContext {
        ...
        public PairBoolValueContext(PairValueContext ctx) {
            copyFrom(ctx);
        }
    ...
    public final PairValueContext pairValue() throws RecognitionException {
        ...
        try {
            ...
            switch (_input.LA(1)) {
                ...
                {
                    setState(331);
                    ((PairStringValueContext) _localctx).stringValue = match(STRING);
                }
                break;
                case INT:
                ...
                {
                    setState(332);
                    ((PairIntValueContext) _localctx).intValue = match(INT);
                }
                break;
                case TRUE:
                case FALSE:
                ...
                {
                    setState(333);
                    ((PairBoolValueContext) _localctx).boolValue = bool();
                }
                break;
                default:
                    throw new NoViableAltException(this);
    ...
    public static class BoolContext extends ParserRuleContext {
        public TerminalNode FALSE() {
            return getToken(ContactParser.FALSE, 0);
        }

        public TerminalNode TRUE() {
            return getToken(ContactParser.TRUE, 0);
        }
